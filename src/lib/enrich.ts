import type { EnrichedMedikamentenUebersicht, EnrichedPackungen } from '@/types/enriched';
import type { Medikamente, MedikamentenUebersicht, Packungen } from '@/types/app';
...
export function enrichMedikamentenUebersicht(
  ...
  return medikamentenUebersicht.map(r => ({
    ...r,
    laufende_packungenName: resolveDisplay(r.fields.laufende_packungen, maps.packungenMap, 'bemerkungen'),
  }));
}
