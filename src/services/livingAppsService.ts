...
import type { Medikamente, Dosierung, Packungen, MedikamentenUebersicht, CreateMedikamente, CreateDosierung, CreatePackungen, CreateMedikamentenUebersicht } from '@/types/app';
